<x-layout.app :profile="$profile" :categories="$categories">
    ...
    <div class="bg-blue-950 text-white py-10">
        <div class="max-w-6xl mx-auto px-4">
            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium {{ $style['bg'] }} mb-3">
            ...
            <p class="text-blue-200 text-sm mt-2">
                Menampilkan artikel kategori {{ strtolower($category->name) }}
            </p>
        </div>
    </div>
        ...
        <div class="max-w-6xl mx-auto px-4 md:px-6 lg:px-8 py-8">
            ...
            <div class="flex flex-wrap gap-3 mb-8">
                ...
                @foreach ($categories as $cat)
                   ...
                   {{ $cat->id === $category->id ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
                        {{ $cat->name }}
                    </a>
                @endforeach
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse ($articles as $article)
                    <article class="bg-white rounded-xl shadow border border-gray-100 hover:shadow-lg transition">
                        ...
                        <div class="p-5">
                            <h2 class="text-lg font-bold text-gray-900 mb-2 hover:text-blue-700">
